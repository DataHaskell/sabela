...
CURATION = [
    {
        ...
        # Dashboard export (generated by tools/gen-dashboards.sh, which loads the
        # notebook in a throwaway editor and repoints the model viewers at the
        # author's committed public assets).
        "dashboard": "scripts/dashboards/csg.html",
    },
    {
        "slug": "b1ef0001",
