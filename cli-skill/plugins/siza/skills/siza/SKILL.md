...
- **Exploration goes through `try`,** never a long `execute_cell` against the live kernel — Sabela selects the safe internal route and bounds pure-live evaluation.
