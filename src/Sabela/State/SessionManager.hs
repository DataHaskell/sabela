...
modifyHaskellSession :: SessionManager -> (Maybe SessionBackend -> IO (Maybe SessionBackend)) -> IO ()
...
modifyLeanSession :: SessionManager -> (Maybe LeanSession -> IO (Maybe LeanSession, a)) -> IO a
...
modifyPythonSession :: SessionManager -> (Maybe SessionBackend -> IO (Maybe SessionBackend, a)) -> IO a
