...
systemPrompt =
    T.unlines
        ...
        , "GHCi meta-commands and compile-time escapes (including TH and FFI), and"
        , "it type-checks unrestricted IO without running it. Put code that must"
        , "perform those owned effects in a notebook cell."
        , ""
